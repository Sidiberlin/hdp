...
( function () {
	...
	MMVB.processThumb = function ( thumb ) {
		...
		if ( isFilePageMainThumb ) {
			...
			var matches = src.match( /\/(archive)\/[a-f0-9]\/[a-f0-9]{2}\/([0-9]{14})!([^\s]+)\/([^\s]+)$/ );
			if ( matches === null ) {
